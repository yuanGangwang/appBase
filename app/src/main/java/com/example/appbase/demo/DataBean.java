...
public class DataBean {
    ...
    public static List<DataBean> getTestData() {
        ...
        list.add(new DataBean(R.mipmap.ic_launcher, "相信自己,你努力的样子真的很美", 1));
        list.add(new DataBean(R.mipmap.ic_launcher, "极致简约,梦幻小屋", 3));
        list.add(new DataBean(R.mipmap.ic_launcher, "超级卖梦人", 3));
        list.add(new DataBean(R.mipmap.ic_launcher, "夏季新搭配", 1));
        list.add(new DataBean(R.mipmap.ic_launcher, "绝美风格搭配", 1));
        list.add(new DataBean(R.mipmap.ic_launcher, "微微一笑 很倾城", 3));
        return list;
    }

    public static List<DataBean> getTestData2() {
        List<DataBean> list = new ArrayList<>();
        list.add(new DataBean(R.mipmap.ic_launcher, "听风.赏雨", 3));
        list.add(new DataBean(R.mipmap.ic_launcher, "迪丽热巴.迪力木拉提", 1));
        list.add(new DataBean(R.mipmap.ic_launcher, "爱美.人间有之", 3));
        list.add(new DataBean(R.mipmap.ic_launcher, "洋洋洋.气质篇", 1));
        list.add(new DataBean(R.mipmap.ic_launcher, "生活的态度", 3));
        return list;
    }
    ...
    public static List<DataBean> getTestDataVideo() {
        ...
        list.add(new DataBean(R.mipmap.ic_launcher, "听风.赏雨", 1));
        list.add(new DataBean(R.mipmap.ic_launcher, "迪丽热巴.迪力木拉提", 1));
        list.add(new DataBean(R.mipmap.ic_launcher, "爱美.人间有之", 1));
        list.add(new DataBean(R.mipmap.ic_launcher, "洋洋洋.气质篇", 1));
        list.add(new DataBean(R.mipmap.ic_launcher, "生活的态度", 1));
        return list;
    }
